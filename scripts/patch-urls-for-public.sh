...
#
# Replaces the develop-branch API URL (api-dev.peddlum.com) with the
# production URL (api.peddlum.com) in src/constants.ts. Called from
...
# is rsync'd to the public peddlum/node-sdk repo.
