export { PeddlumClient } from './peddlum-client';
export type { PeddlumClientOptions } from './peddlum-client';
...
export type { PeddlumErrorCode } from './core/errors';

// Constants (exposed for tooling; generated apps don't usually import these)
export { PEDDLUM_BASE_URL } from './constants';
