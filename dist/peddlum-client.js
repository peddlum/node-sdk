...
class PeddlumClient {
    constructor(apiKey, options = {}) {
        if (!apiKey) {
            throw new Error('PeddlumClient: API key is required. Get one from the peddlum seller dashboard.');
        }
        if (!apiKey.startsWith('service_') && !apiKey.startsWith('anon_')) {
            ...
            console.warn('PeddlumClient: API key should start with "service_" or "anon_".');
        }
...
exports.PeddlumClient = PeddlumClient;
//# sourceMappingURL=peddlum-client.js.map